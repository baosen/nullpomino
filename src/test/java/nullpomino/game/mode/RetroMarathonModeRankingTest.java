...
/**
 * Covers the private ranking helpers in {@link RetroMarathonMode}: checkRanking
 * (score-primary, lines-secondary, level-tertiary where lower level is better)
 * and updateRanking.
 */
class RetroMarathonModeRankingTest {

	// -----------------------------------------------------------------------
	// checkRanking — score primary, lines secondary, lower level is tertiary
	// -----------------------------------------------------------------------
	...
	private static int invokeCheckRanking(RetroMarathonMode mode, int sc, int li, int lv, int type)
			throws Exception {
	...
	private static void invokeUpdateRanking(RetroMarathonMode mode, int sc, int li, int lv, int type)
			throws Exception {
		Method m = RetroMarathonMode.class.getDeclaredMethod(
