...
/**
 * Drives {@link DigRaceMode#onSetting} across every numeric configuration
 ...
 */
class DigRaceModeSettingWraparoundTest {
	...
	private static void change(DigRaceMode mode, GameEngine engine, int cursor, int dirButton, int multButton) throws Exception {
	...
	void bgmGoaltypeAndPresetWrapAtBothBounds() throws Exception {
		...
		// case 9/10: presetNumber (shared switch arm)
