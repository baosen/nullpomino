...
public class Field implements Serializable {
	...
	public int[] checkForSquares() {
		return FieldColorClear.checkForSquares(this);
	}
	...
	public int[] getHowManySquareClears() {
		return FieldColorClear.getHowManySquareClears(this);
	}
	...
	{
		return FieldColorClear.clearLineColor(this, size, diagonals, gemSame);
	}
	/**
	...
	{
		return FieldColorClear.checkLineColor(this, size, flag, diagonals, gemSame);
	}
	/**
	...
	{
		return FieldColorClear.gemClearColor(this, size, garbageClear, ignoreHidden);
	}
	public int gemClearColor (int size, boolean garbageClear)
	{
		return FieldColorClear.gemClearColor(this, size, garbageClear);
	}
	/**
	...
	{
		return FieldColorClear.clearColor(this, size, garbageClear, gemSame, ignoreHidden);
	}
	public int clearColor (int size, boolean garbageClear, boolean gemSame)
	{
		return FieldColorClear.clearColor(this, size, garbageClear, gemSame);
	}
	/**
	...
	{
		return FieldColorClear.clearColor(this, x, y, flag, garbageClear, gemSame, ignoreHidden);
	}
