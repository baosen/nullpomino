...
public class NetDummyVSMode extends NetDummyMode {
	...
	/**
	 * NET-VS: Draw player's place and win/play count on the race modes' HUD
	 * @param engine GameEngine
	 * @param playerID Player ID
	 * @param x X-coordinate of the field display
	 * @param y Y-coordinate of the field display
	 * @param place Player's current place (0 = 1st)
	 */
	protected void netvsDrawPlaceAndPlayCount(GameEngine engine, int playerID, int x, int y, int place) {
	...
	/**
	 * NET-VS: Draw player's win/play count
	 * @param engine GameEngine
	 * @param playerID Player ID
	 * @param x X-coordinate of the field display
	 * @param y Y-coordinate of the field display
	 */
	protected void netvsDrawPlayCount(GameEngine engine, int playerID, int x, int y) {
	...
	/**
	 * NET-VS: Draw the race modes' result stats (lines, pieces, lpm, pps, time)
	 * @param engine GameEngine
	 * @param playerID Player ID
	 */
	protected void netvsDrawRaceResultStats(GameEngine engine, int playerID) {
		float scale = 1.0f;
