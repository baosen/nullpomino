...
public class SPFMode extends AbstractMode {
	...
	private static final String[] DROP_SET_NAMES = SPFDropData.DROP_SET_NAMES;

	private static final int[][][][] DROP_PATTERNS = SPFDropData.DROP_PATTERNS;
	private static final double[][] DROP_PATTERNS_ATTACK_MULTIPLIERS = SPFDropData.DROP_PATTERNS_ATTACK_MULTIPLIERS;
	private static final double[][] DROP_PATTERNS_DEFEND_MULTIPLIERS = SPFDropData.DROP_PATTERNS_DEFEND_MULTIPLIERS;
	...
	private void loadDropMapPreview(GameEngine engine, int playerID, int[][] pattern) {
		if(pattern != null) log.debug("Loading drop map preview");
		SPFDropData.loadDropMapPreview(engine, pattern);
	}
	...
	{
		return SPFDropData.getAttackMultiplier(set, map);
	}
	public static double getDefendMultiplier(int set, int map)
	{
		return SPFDropData.getDefendMultiplier(set, map);
	}
	/*
