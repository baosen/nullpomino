...
```bash
web/build-site.sh          # build optimized production bundle
web/build-site.sh --dev    # build readable JavaScript for local debugging
python3 -m http.server -d web/dist 8000 # serve build; other static file servers works too!
```
